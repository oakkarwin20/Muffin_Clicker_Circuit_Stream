...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //InvokeRepeating(nameof(CollectMuffinPassive), 5f, 1f);
    }
    ...
    {
        float x = UnityEngine.Random.Range(-50f, 400f);
            float y = UnityEngine.Random.Range(-100f, 200f);
    ...
    private void LoadGame()
    {
        ...
        //Convert the save data object into JSON (Deserialize it!)
