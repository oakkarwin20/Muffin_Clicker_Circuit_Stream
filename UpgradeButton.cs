...
public class UpgradeButton : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Calculate the curernt price of the upgrade
        price = (level + 1) * pricePerLevel;

        //Update the price text
        priceText.text = price.ToString();

        //Color the price text accordinglhy to whether the player can afford it or not
    ...
    //    priceText.color = gameManager.CanBuy(price, upgradeType) ? Color.green : Color.red;
    //}
